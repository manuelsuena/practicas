...
public class PDeportivo extends JPanel{
    ...
    private void colocarTextoArtistico(){
        ...
        textoDeportivo.setText("Representación pública de obras teatrales, artísticas o escénicas, mediante la utilización, aislada o conjuntamente, del lenguaje, de la mímica, de la música, del cómic, de marionetas u otros objetos a cargo de artistas, intérpretes o ejecutantes, sean o no profesionales, en establecimientos cerrados o al aire libre, debidamente acondicionados y habilitados para eso.");
        textoDeportivo.setMinimumSize(new Dimension(200, 100));
        textoDeportivo.setOpaque(false);
        textoDeportivo.setPreferredSize(new Dimension(400, 150));
        ...
        gridBagConstraints.insets = new Insets(-220, 500, 0, 0);
        this.add(textoDeportivo, gridBagConstraints);
    }

    private void colocarBotones(){
        botonDeportivo = new BotonPrincipal("TEATRAL");
        ...
        gridBagConstraints.insets = new Insets(-280, 500, 0, 0);
